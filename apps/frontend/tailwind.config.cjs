  ...
  theme: {
    extend: {
      colors: {
        ...
        ai: 'var(--new-ai-btn)',
        onboardingPrimary: 'var(--new-onboarding-primary)',
        onboardingPrimaryEnd: 'var(--new-onboarding-primary-end)',
        onboardingPrimaryHover: 'var(--new-onboarding-primary-hover)',
        supportBtnBg: 'var(--new-support-btn-bg)',
        supportBtnText: 'var(--new-support-btn-text)',
