...
- [ ] **Step 2: Write failing authorization-validation tests**
...
- [ ] **Step 4: Implement minimal authorization validation**
...
- [ ] **Step 5: Add and verify token-validation tests**
...
- [ ] **Step 6: Add and verify the PKCE test**
...
- Produces: `OAuthStateStore.fetch()` private operations for `put`, `take`, and `delete-expired`
...
- [ ] **Step 3: Implement the strongly consistent store**
...
- [ ] **Step 4: Add eviction and concurrency coverage**
...
- [ ] **Step 1: Write failing `/health` and `/authorize` integration tests**
...
- [ ] **Step 3: Implement `/health` and `/authorize`**
...
- [ ] **Step 8: Write failing `/userinfo` tests**
...
- [ ] **Step 9: Implement `/userinfo` and safe structured logging**
...
- [ ] **Step 1: Generate and store downstream credentials**
...
- [ ] **Step 3: Deploy Worker and custom domain**

Deploy Worker `crove-sso` with compatibility date `2026-08-14`, `nodejs_compat`, Durable Object migration `v1`, observability enabled, and custom domain `sso.crove.com`.

- [ ] **Step 4: Verify deployed fail-closed behavior**
...
- [ ] **Step 5: Update Supabase OAuth client**
...
- [ ] **Step 6: Configure Postiz production endpoints but keep SSO hidden**
...
- [ ] **Step 1: Obtain a verified upstream identity**
...
- [ ] **Step 2: Re-run exact database preconditions**
...
- [ ] **Step 3: Create a minimal identity backup**
...
- [ ] **Step 4: Bind the identity transactionally**
...
- [ ] **Step 1: Activate DOS ID and recreate Postiz**
...
- [ ] **Step 6: Inspect health and logs**
...
- [ ] **Step 8: Commit final operational documentation changes if any**
