...
export const Support = () => {
  ...
  return (
    <div
      id="support-discord"
      className="bg-supportBtnBg w-[194px] h-[58px] fixed end-[20px] bottom-[20px] z-[500] text-[16px] text-supportBtnText rounded-[30px] !rounded-br-[0] cursor-pointer flex justify-center items-center gap-[10px]"
